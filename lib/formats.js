...
const FORMATS = [
  ...
  { id: 'skins', name: 'Skins', sub: 'Stroke Play', tier: 'individual',
    ...
    settings: [
      ...
      { key: 'allow_carryover', label: 'Carry tied skins forward', type: 'toggle', default: true,
        hint: 'ON: a tied hole carries its skin to the next hole (so the next is worth 2). OFF: a tied skin is dead — the next hole is back to 1.' },
    ] },
