...
const FORMATS = [
  ...
  { id: 'nassau', name: 'Nassau', sub: 'Front / Back / Total', tier: 'individual',
    engine: 'nassau', net: true, allowance: 0.95, teamSize: [1, 1], scored: false,
    manualScoring: true,
    emoji: '🏆',
  ...
  { id: 'bingo_bango_bongo', name: 'Bingo Bango Bongo', sub: 'Points per hole', tier: 'individual',
    engine: 'bbb', net: false, allowance: 1.0, teamSize: [1, 1], scored: false,
    manualScoring: true,
    emoji: '🔔',
  ...
  { id: 'dots', name: 'Dots', sub: 'Garbage', tier: 'individual',
    engine: 'dots', net: false, allowance: 1.0, teamSize: [1, 1], scored: false,
    manualScoring: true,
    emoji: '🎰',
  ...
  { id: 'snake', name: 'Snake', sub: 'Three-putt penalty', tier: 'individual',
    engine: 'snake', net: false, allowance: 1.0, teamSize: [1, 1], scored: false,
    manualScoring: true,
    emoji: '🐍',
  ...
  { id: 'foursomes_stroke', name: 'Alternate Shot', sub: 'Foursomes (Stroke)', tier: 'pair',
    engine: 'foursomes_stroke', net: true, allowance: 'foursomes', teamSize: [2, 2], scored: false,
    manualScoring: true,
    emoji: '🔁',
  ...
  { id: 'chapman', name: 'Chapman', sub: 'Pinehurst', tier: 'pair',
    engine: 'chapman', net: true, allowance: 0.6, teamSize: [2, 2], scored: false,
    manualScoring: true,
    emoji: '🌲',
  ...
  { id: 'sixes', name: 'Sixes', sub: 'Round Robin pairs', tier: 'pair',
    engine: 'sixes', net: true, allowance: 0.85, teamSize: [2, 2], scored: false,
    manualScoring: true,
    emoji: '🔄',
